...
ffi.Utf8String = {
  ...
  , get: function get (buf, offset) {
      var _buf = buf.readPointer(offset, 9999)
  ...
  , set: function set (buf, offset, val) {
      ...
      if (val === null || typeof val === 'undefined') {
        ...
        _buf = new Buffer(Buffer.byteLength(val, 'utf8') + 1)
        _buf.write(val, 0, _buf.length)
        _buf[_buf.length - 1] = 0 // null terminate the C string
      }
