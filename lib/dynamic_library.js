...
var dlopen = ffi.ForeignFunction(ffi.Bindings.StaticFunctions.dlopen, voidPtr, [ string, ref.types.int ])
  , dlclose = ffi.ForeignFunction(ffi.Bindings.StaticFunctions.dlclose, ref.types.int, [ voidPtr ])
  , dlsym = ffi.ForeignFunction(ffi.Bindings.StaticFunctions.dlsym, voidPtr, [ voidPtr, string ])
  , dlerror = ffi.ForeignFunction(ffi.Bindings.StaticFunctions.dlerror, string, [ ])
...
function DynamicLibrary (path, mode) {
  ...
  console.log(this._handle, this._handle.address())
